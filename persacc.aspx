        ...
        <asp:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="1" 
            ...
            <ContentTemplate>
                ...
                <table><tr><td style="padding:20px 20px 20px 20px; width:400px">
                    ...
                    <asp:Label ID="lblLitresLogin" runat="server" Text="Логин для Литрес:"></asp:Label><br />
                    <asp:Label ID="lblLitresPwd" runat="server" Text="Пароль для Литрес:"></asp:Label><br /><br /><br /><br />
                    <asp:Label ID="Label3" runat="server" Text="В настоящее время закончились логины для Литрес. Попробуйте позже." Visible = "false"></asp:Label><br /><br /><br />
                    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl = "http://biblio.litres.ru/" Target="_blank">Литрес</asp:HyperLink><br /><br />
                    <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl = "http://biblio.litres.ru/biblioapps/" Target="_blank" >Мобильное приложение Литрес</asp:HyperLink><br /><br />
                </td></tr></table>
                </asp:Panel>
            </ContentTemplate>
            </asp:TabPanel>
